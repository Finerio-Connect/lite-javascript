...
-----END PUBLIC KEY-----`;
  ...
  doGet( url, successFunction, component ) {
    ...
    return this.getAccessToken().then( function( accessToken ) {
      ...
      return new Promise( ( resolve, reject ) => {
        ...
        axios.get( url, { headers: headers , httpsAgent: agent } )
          .then( response =>
  ...
  doPost( url, body, successFunction, component ) {
    ...
    return this.getAccessToken().then( function( accessToken ) {
      ...
      return new Promise( ( resolve, reject ) => {
        ...
        axios.post( url, body, { headers: headers , httpsAgent: agent } )
          .then( response =>
            resolve( successFunction( response, component ) )
          ).catch( error =>
            component.processErrors( error, component, reject )
  ...
  doPut( url, body, successFunction, component ) {
    ...
    return this.getAccessToken().then( function( accessToken ) {
      ...
      return new Promise( ( resolve, reject ) => {
        ...
        axios.put( url, body, { headers: headers , httpsAgent: agent } )
          .then( response =>
            resolve( successFunction( response, component ) )
          ).catch( error =>
            component.processErrors( error, component, reject )
  ...
  doDelete( url, component ) {
    ...
    return this.getAccessToken().then( function( accessToken ) {
      ...
      return new Promise( ( resolve, reject ) => {
        ...
        axios.delete( url, { headers: headers , httpsAgent: agent } )
  ...
  login() {
    ...
    return new Promise( ( resolve, reject ) => {
      ...
      axios.post( url, body , { httpsAgent: agent }  )
